...
const unsigned int EEPROM_WE = 22;
const unsigned int EEPROM_OE = 23;
const unsigned int EEPROM_CE = 9;

// 74HC595 control lines
const unsigned int SHIFT_OE = 8;
const unsigned int SHIFT_SER = 12;
const unsigned int SHIFT_RCLK = 11;
const unsigned int SHIFT_SCLK = 10;
const unsigned int SHIFT_CLR = 7;

// Activity indicator LED
const unsigned int ACT_LED = 13;

// Data pins (LSB to MSB)
const unsigned int dataPins[] = {14, 15, 16, 17, 18, 19, 20, 21};
